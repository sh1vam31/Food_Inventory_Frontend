    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow">
          <div className="flex items-center">
            ...
            >
              <Package className="h-8 w-8" style={{ color: '#2F855A' }} />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Raw Materials</p>
              <p className="text-3xl font-bold" style={{ color: '#2F855A' }}>{stats.totalRawMaterials}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow">
          <div className="flex items-center">
            <div 
              ...
              style={{ backgroundColor: 'rgba(47, 133, 90, 0.1)' }}
            >
              <ShoppingCart className="h-8 w-8" style={{ color: '#2F855A' }} />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Orders</p>
              <p className="text-3xl font-bold" style={{ color: '#2F855A' }}>{stats.totalOrders}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/inventory" className="text-sm font-medium transition-colors" style={{ color: '#2F855A' }}>
              View All →
            </Link>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/orders" className="text-sm font-medium transition-colors" style={{ color: '#2F855A' }}>
              View All →
            </Link>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link 
            href="/inventory/add" 
            className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 p-4 rounded-lg text-center font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            style={{ '--hover-border': '#2F855A', '--hover-text': '#2F855A' } as any}
            onMouseEnter={(e) => {
