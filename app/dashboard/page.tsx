...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-emerald-600 dark:bg-emerald-700 text-white p-8 rounded-2xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow hover-lift">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/inventory" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 text-sm font-medium">
              View All →
            </Link>
          </div>
          ...
          {lowStockItems.length === 0 ? (
            ...
            <div className="space-y-3">
              {lowStockItems.slice(0, 5).map((item) => (
                <div key={item.id} className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  <div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/orders" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 text-sm font-medium">
              View All →
            </Link>
          </div>
                ...
                <div key={order.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <div className="text-right">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      order.status === 'PLACED' ? 'bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300' :
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link 
            href="/inventory/add" 
            className="bg-emerald-600 hover:bg-emerald-700 text-white p-4 rounded-lg text-center font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Add Raw Material
          </Link>
          <Link 
            href="/menu/add" 
            className="bg-teal-600 hover:bg-teal-700 text-white p-4 rounded-lg text-center font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Create Food Item
          </Link>
          <Link 
            href="/orders/new" 
            className="bg-emerald-700 hover:bg-emerald-800 text-white p-4 rounded-lg text-center font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Place New Order
          </Link>
        </div>
